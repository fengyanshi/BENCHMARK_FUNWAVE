...
folder_result='../results_sp_shock/';
data=load('ht_setup_061071.txt');
x_data=data(:,1);
ht_data=data(:,2);
set_data=data(:,3);
...
station(:,num)=time_eta(200:end,2);
end
...
save -ASCII spilling_shock_case.txt output
