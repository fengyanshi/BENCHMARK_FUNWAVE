...
clear tote
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pname=['result_vis',num2str(tstart),'.mat'];
...
fname=['result_vis',num2str(tstart),'_',num2str(tend),'.eps'];
set(gcf,'PaperPositionMode', 'auto');
print('-depsc2',fname);

pname = ['result_vis',num2str(tstart),'_',num2str(tend),'.png'];
set(gcf,'PaperPositionMode', 'auto');
print ('-dpng', pname);
